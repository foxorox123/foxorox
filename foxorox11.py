...
sp500_top10 = get_sp500_tickers()  # teraz mamy pełną listę wszystkich spółek S&P 500
...
def sort_treeview(tree, col, reverse, is_percentage=False):
    ...
    # Przesuń elementy w Treeview
    for index, (_, k) in enumerate(data):
        tree.move(k, '', index)

    # Dodaj ikonę do nagłówka sortowanej kolumny
...
# Dodajemy ramkę z kontrolkami wyboru wykresu nad wykresem
...
# Drzewo wyników z paskiem przewijania
...
# Nagłówki z sortowaniem i ikonami
...
tree.column("Gap %", width=80, anchor='center')
tree.column("Candle Color", width=100, anchor='center')
tree.column("Candle %", width=80, anchor='center')
