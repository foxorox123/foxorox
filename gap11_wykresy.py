...
# Lista spółek z WIG20 wraz z tickerami Yahoo Finance
sp500_top10 = {
    'ALLEGRO': 'ALE.WA',
    'ALIOR': 'ALR.WA',
    'BUDIMEX': 'BDX.WA',
...
def show_plot(df, title):
    ...
    data_tail = df.tail(plot_range.get()).copy()
...
plot_range = tk.IntVar(value=50)  # Domyślnie 50 sesji
...
ttk.Label(left_frame, text="📊 Select WIG20 company:").pack()
...
ttk.Label(chart_control_frame, text="Sessions to show:").pack(side='left', padx=(20,5))
ttk.Entry(chart_control_frame, textvariable=plot_range, width=5).pack(side='left')
