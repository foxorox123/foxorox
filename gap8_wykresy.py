...
wig20_symbols = {
    ...
    'SANPL': 'spl',
    'TAURON': 'tpe',
    'ZABKA': 'zab'  # ⚠️ Upewnij się, że 'zab' istnieje na stooq.pl
}
...
def fetch_data(symbol):
    try:
        ...
        if "Data" not in content.splitlines()[0]:
            raise Exception("Brak nagłówka 'Data' w danych Stooq")

        data = pd.read_csv(io.StringIO(content), parse_dates=['Data'])
