...
# ✅ Zaktualizowany skład WIG20 na podstawie najnowszych notowań
wig20_symbols = {
    'ALLEGRO': 'ALE.WA',   # Allegro Yahoo ticker
    'ALIOR': 'ALR.WA',
    'BUDIMEX': 'BDX.WA',
    'CCC': 'CCC.WA',
    'CDPROJEKT': 'CDR.WA',
    ...
    'SANPL': 'SPL.WA',
    'TAURON': 'TPE.WA',
    'ZABKA': 'ZABKA'  # ⚠️ sprawdź czy jest dostępny na Yahoo Finance
}
...
def show_plot(df, title):
    ...
    data_tail['Volume'] = data_tail['Volume'] / 1_000_000  # mln PLN
