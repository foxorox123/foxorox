...
ttk.Label(left_frame, text="📉 Set gap threshold (%)").pack()
...
ttk.Button(left_frame, text="🔍 Analyze one stock", command=update_prediction).pack(pady=5)
...
# Drzewo wyników
tree = ttk.Treeview(left_frame, columns=("Company", "Gap %", "Candle Color", "Candle %"), show="headings", height=10)
